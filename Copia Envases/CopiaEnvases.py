...
try:
    ...
    for idx, id_coti in enumerate(lista_id_coti):
        ...
        df_coti = df_entrada[df_entrada["ID COTI"] == id_coti][["ID MUESTRA", "N COPIAS"]]
        lista_muestras_coti = [str(_) for _ in list(df_coti['ID MUESTRA'])]
